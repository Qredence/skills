...
This guide covers AgenticFleet-specific DSPy patterns, debugging techniques, and common issues with solutions.

## Table of Contents

- [AgenticFleet DSPy Architecture](#agenticfleet-dspy-architecture)
...
**Problem**:
```
ModuleNotFoundError: No module named 'agentic_fleet.dspy_modules'
```

**Solution**:
1. Ensure you're in the project root
2. Install dependencies: `uv sync`
3. Use absolute imports: `from agentic_fleet.dspy_modules import ...`
...
2. **Use absolute imports in AgenticFleet**
